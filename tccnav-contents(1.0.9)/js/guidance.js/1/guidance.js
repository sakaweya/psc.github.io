...
var pageRefresh = function () {
    ...
    var els_t_p = ['#div_main_menu_port .navtop', '#div_main_menu_port .navsearch', '#div_main_menu_port .navcontact'];
    var els_t_l = ['#div_main_menu_land .navtop', '#div_main_menu_land .navsearch', '#div_main_menu_land .navcontact'];
    var els_m = ['#div_mobile_menu .navtop', '#div_mobile_menu .navsearch', '#div_mobile_menu .navcontact'];
    var els;
    var max_height = 0;
